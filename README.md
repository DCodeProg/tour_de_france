...
create table public.editions (
  ...
  nb_etapes smallint not null,
  distance_totale real not null,
...
create table public.etapes (
  ...
  ville_depart character varying null,
  ville_arrive character varying null,
  ...
  constraint etapes_ville_depart_fkey foreign KEY (ville_depart) references villes (code) on update CASCADE on delete RESTRICT,
  constraint etapes_ville_arrive_fkey foreign KEY (ville_arrive) references villes (code) on update CASCADE on delete RESTRICT
) TABLESPACE pg_default;
```
...
create table public.resultats_etape (
  ...
  constraint resultats_etape_num_etape_annee_edition_fkey foreign KEY (num_etape, annee_edition) references etapes (numero, annee_edition) on update CASCADE on delete CASCADE
) TABLESPACE pg_default;
```
